"""
URL configuration for asistencia_crud project.
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="Documentación completa del sistema de gestión de asistencia y usuarios",
...
urlpatterns = [
    ...
    # Ruta raíz temporal para evitar el 404
